...
const Home = () => {
    ...
    const { loading, generateReport, reports, deleteReport } = useInterview() // ✅ deleteReport add kiya
    ...
    return (
        <div className='home-page'>
            ...
            <header className='page-header'>
                ...
                <p>Let our AI evaluate the job requirements and your profile to craft a personalized strategy.</p>
            </header>
                        ...
                        {reports.map(report => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    onClick={(e) => {
                                        e.stopPropagation() // ✅ Card navigate na ho
